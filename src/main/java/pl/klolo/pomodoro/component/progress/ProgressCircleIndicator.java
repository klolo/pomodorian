 ...
 *
 */
public abstract class ProgressCircleIndicator extends Control {
    ...
    public ProgressCircleIndicator() {
        this.getStylesheets().add(getClass().getClassLoader().getResource("css/circleprogress.css").toExternalForm());
    }
