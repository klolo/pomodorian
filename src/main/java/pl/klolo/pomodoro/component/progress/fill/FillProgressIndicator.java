 ...
 */
package pl.klolo.pomodoro.component.progress.fill;

import javafx.scene.control.Skin;
import pl.klolo.pomodoro.component.progress.ProgressCircleIndicator;
...
public class FillProgressIndicator extends ProgressCircleIndicator {
    ...
    public FillProgressIndicator() {
        this.getStylesheets().add(Objects.requireNonNull(getClass().getClassLoader().getResource("css/fillprogress.css")).toExternalForm());
